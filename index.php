	...
	<div class="container-fluid callouts">
		<div class="row">
				<div class="col-md-4 members">
					<img src="http://localhost:8888/bronson/wp-content/uploads/2018/01/dragon_strikes-300x169.jpg" alt="The Dragon Strkes Again">
				<h1>Members</h1>
				...
				<div class="col-md-4 screenings">
					<img src="http://localhost:8888/bronson/wp-content/uploads/2018/01/tourist-300x171.jpg">
				<h1>Screenings</h1>
				...
				<div class="col-md-4 upcoming">
					<img src="http://localhost:8888/bronson/wp-content/uploads/2018/01/werewolf.jpeg">
				<h1>Upcoming</h1>
